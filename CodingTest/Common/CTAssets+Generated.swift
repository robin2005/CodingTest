...
internal enum Asset {
  internal enum Colors {
    ...
    internal static let textSubColor = ColorAsset(name: "textSubColor")
    internal static let viewBgColor = ColorAsset(name: "viewBgColor")
    internal static let viewSubBgColor = ColorAsset(name: "viewSubBgColor")
  }
  internal enum Icons {
    internal static let close = ImageAsset(name: "close")
    internal static let collect = ImageAsset(name: "collect")
    internal static let destination = ImageAsset(name: "destination")
    ...
    internal static let zoomOut = ImageAsset(name: "zoomOut")
  }
}
